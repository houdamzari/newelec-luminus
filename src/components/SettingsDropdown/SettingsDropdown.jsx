  ...
  return (
    <div className="w-full mobile:hidden">
      <div className="relative w-fit" ref={ref}>
        <div onClick={() => setOpen(!open)} className="w-fit  py-2 ">
          <Flex
          ...
          >
            <img className="w-[39px]" src={user} alt="option_icon" />
            <Flex
              flexDirection={"flex-col"}
              justifyContent={"justify-center"}
              className=" cursor-pointer gap-0"
            >
              <div className="w-fit text-sm">Blaise Deflo</div>
          ...
          <div className="absolute top-[60px] w-[160px] bg-white left-0 rounded flex flex-col shadow-md">
            ...
            <div className="px-4 py-2 w-full">
              <Flex
                ...
                className="justify-start"
              >
                <img src={logoutIcon} alt="option_icon" />
